...
<body>
    <header id="header">
        ...
        <nav id="navbar">
            <ul>
                <li><a href="#" class="active">Μαθήματα</a></li>
    ...
    <p class="pag_title" align="center"><strong><font size="+4">Μαθήματα</font></strong><br/>
    <center>
    <div class="container">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            $sql = "SELECT subject.NAME,subject.SID, teaches.PID FROM `SUBJECT` subject LEFT OUTER JOIN TEACHES teaches ON subject.SID = teaches.SID WHERE teaches.PID = $pPID";
            ...
            // while($row = $queryexe->fetch_assoc()){
                ...
                <td> <a href='professor_grade.php?subjectID=$sSID'>$subjname </td>
                <td>$sSID </td>
